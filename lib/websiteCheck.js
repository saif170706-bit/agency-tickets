...
async function searchSearXNG(companyName, city) {
  ...
  // Kun Bing — Google/DDG/Brave/Startpage er CAPTCHA-blokeret på Railway-IP
  const url = `${baseUrl.replace(/\/$/, "")}/search?q=${encodeURIComponent(query)}&format=json&categories=general&language=da&engines=bing`;
