        ...
        <tr>
          <td style="background:#ffffff;padding:40px;">
            ...
            <p style="margin:0;color:#8aa5a8;font-size:13px;line-height:1.6;">
              Gem venligst dit sagsnummer — du skal bruge det, hvis du henvender dig til os. Har du spørgsmål? <a href="https://buildone.dk/kontakt" style="color:#003135;font-weight:700;">Kontakt os</a> — vi hjælper gerne.
            </p>
          </td>
        </tr>
